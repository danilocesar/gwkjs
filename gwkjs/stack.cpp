...
//
//    if (stack != NULL) {
//        if (!gwkjs_object_get_property_const(context, err_obj,
...
//    if (fileName != NULL) {
//        if (!gwkjs_object_get_property_const(context, err_obj,
//                                           GWKJS_STRING_FILENAME, fileName))
//            goto out;
//    }
//
//    if (lineNumber != NULL) {
//        if (!gwkjs_object_get_property_const(context, err_obj,
//                                           GWKJS_STRING_LINE_NUMBER, lineNumber))
//            goto out;
//    }
//
//    ret = JS_TRUE;
...
//    if (!gwkjs_context_get_frame_info(cx, &v_stack, NULL, NULL) ||
//        !gwkjs_string_to_filename(cx, v_stack, &stack)) {
...
//
//void
//gwkjs_dumpstack(void)
//{
//    GList *contexts = gwkjs_context_get_all();
//    GList *iter;
//
//    for (iter = contexts; iter; iter = iter->next) {
//        GwkjsContext *context = (GwkjsContext*)iter->data;
//        gwkjs_context_print_stack_stderr(context);
