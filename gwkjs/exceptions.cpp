...
/**
 * gwkjs_make_exception:
 * @ctx: A #GwkjsContext.
 * @exception: A reference to a #GwkjsException in which to store the exception.
 ...
 */
void
gwkjs_make_exception(JSContextRef ctx,
                    ...
                    ...)
{
    ...
    gwkjs_object_set_property(ctx, exception_obj, "message", js_message_ref, 0, NULL);
    gwkjs_object_set_property(ctx, exception_obj, "name", js_name_ref, 0, NULL);
...
/**
 * gwkjs_make_exception_from_gerror:
 * @ctx: A #GwkjsContext.
 * @exception: A reference to a #GwkjsException in which to store the exception.
 ...
 */
void
gwkjs_make_exception_from_gerror(JSContextRef ctx,
                                JSValueRef* exception,
                                GError* error)
{
    ...
    *(string->str) = g_unichar_toupper(*(string->str));
    ...
    gwkjs_make_exception(ctx, exception, string->str, error->message, NULL);

    g_string_free(string, TRUE);
}

/**
 * gwkjs_exception_get_name:
 * @ctx: A #GwkjsContext.
 * @exception: A reference to a #GwkjsException.
 *
 ...
 */
gchar*
gwkjs_exception_get_name(JSContextRef ctx, JSValueRef e)
{
    JSValueRef name;
    g_assert((e));
    ...
    name = gwkjs_object_get_property(ctx, (JSObjectRef) e, "name", NULL);
    return gwkjs_jsvalue_to_cstring(ctx, name, NULL);
}

/**
 * gwkjs_exception_get_message:
 * @ctx: A #GwkjsContext.
 * @exception: A reference to a #GwkjsException.
 *
 ...
 */
gchar*
gwkjs_exception_get_message(JSContextRef ctx, JSValueRef e)
{
    JSValueRef name;
    g_assert((e));
    if (!JSValueIsObject(ctx, e))
    ...
    name = gwkjs_object_get_property(ctx, (JSObjectRef) e, "message", NULL);
    return gwkjs_jsvalue_to_cstring(ctx, name, NULL);
}

/**
 * gwkjs_exception_get_line:
 * @ctx: A #GwkjsContext.
 * @exception: A reference to a #GwkjsException.
 *
 ...
 */
guint
gwkjs_exception_get_line(JSContextRef ctx, JSValueRef e)
{
    JSValueRef line;
    g_assert((e));
    if (!JSValueIsObject(ctx, e))
        return 0;
    line = gwkjs_object_get_property(ctx, (JSObjectRef) e, "line", NULL);
    return gwkjs_jsvalue_to_uint(ctx, line, NULL);
}

/**
 * gwkjs_exception_get_file:
 * @ctx: A #GwkjsContext.
 * @exception: A reference to a #GwkjsException.
 *
 ...
 */
gchar*
gwkjs_exception_get_file(JSContextRef ctx, JSValueRef e)
{
    JSValueRef line;
    g_assert((e));
    if (!JSValueIsObject(ctx, e))
        return 0;
    line = gwkjs_object_get_property(ctx, (JSObjectRef) e, "sourceURL", NULL);
    return gwkjs_jsvalue_to_cstring(ctx, line, 0);
}
/**
 * gwkjs_exception_get_stack:
 * @ctx: A #GwkjsContext.
 * @exception: A reference to a #GwkjsException.
 *
 ...
 */
gchar*
gwkjs_exception_get_stack(JSContextRef ctx, JSValueRef e)
{
    JSValueRef stack;
    g_assert((e));
    if (!JSValueIsObject(ctx, e))
        return 0;
    stack = gwkjs_object_get_property(ctx, (JSObjectRef) e, "stack", NULL);
    return gwkjs_jsvalue_to_cstring(ctx, stack, 0);
}

/**
 * gwkjs_exception_to_string:
 * @ctx: A #GwkjsContext.
 * @exception: A reference to a #GwkjsException.
 *
 ...
 */
gchar*
gwkjs_exception_to_string(JSContextRef ctx, JSValueRef e)
{
    guint line;
    gchar *mes, *name, *file, *ret, *stack;

    line = gwkjs_exception_get_line(ctx, e);
    mes = gwkjs_exception_get_message(ctx, e);
    file = gwkjs_exception_get_file(ctx, e);
    name = gwkjs_exception_get_name(ctx, e);
    stack = gwkjs_exception_get_stack(ctx, e);
