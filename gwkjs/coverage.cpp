...
//};
//
//G_DEFINE_TYPE_WITH_PRIVATE(GwkjsCoverage,
//                           gwkjs_coverage,
//                           G_TYPE_OBJECT)
//
//enum {
...
//
//typedef struct _GwkjsCoverageBranchExit {
//    unsigned int line;
//    unsigned int hit_count;
//} GwkjsCoverageBranchExit;
//
//typedef struct _GwkjsCoverageBranch {
//    GArray       *exits;
//    unsigned int point;
//    gboolean     hit;
//} GwkjsCoverageBranch;
//
//typedef struct _GwkjsCoverageFunction {
//    char         *key;
//    unsigned int line_number;
//    unsigned int hit_count;
//} GwkjsCoverageFunction;
//
//static void
...
//        GwkjsCoverageFunction *function = &(g_array_index(functions, GwkjsCoverageFunction, i));
...
//    GwkjsCoverageFunction *function = (GwkjsCoverageFunction *) value;
//
...
//                        gpointer user_data)
//{
//    GwkjsCoverageBranch   *branch = (GwkjsCoverageBranch *) branch_ptr;
...
//        GwkjsCoverageBranchExit *exit = &(g_array_index(branch->exits, GwkjsCoverageBranchExit, i));
...
//                gwkjs_throw(context, "Failed to get function names array element %d", i);
//                return FALSE;
//            }
//
//            if (!(inserter(c_side_array, context, &element))) {
//                g_array_unref(c_side_array);
//                gwkjs_throw(context, "Failed to convert array element %d", i);
//                return FALSE;
//            }
//        }
//    }
...
//
//static void
//init_covered_function(GwkjsCoverageFunction *function,
//                      char                *key,
//                      unsigned int        line_number,
//                      unsigned int        hit_count)
//{
...
//{
//    GwkjsCoverageFunction *info = (GwkjsCoverageFunction *) info_location;
//    g_free(info->key);
//}
//
//static gboolean
...
//        gwkjs_throw(context, "Failed to get name property for function object");
//        return FALSE;
//    }
//
//    char *utf8_string;
...
//                                &utf8_string)) {
//            gwkjs_throw(context, "Failed to convert function_name to string");
//            return FALSE;
//        }
//    } else if (JSVAL_IS_NULL(function_name_property_value)) {
//        utf8_string = NULL;
//    } else {
//        gwkjs_throw(context, "Unexpected type for function_name");
//        return FALSE;
//    }
//
...
//        gwkjs_throw(context, "Failed to get hitCount property for function object");
//        return FALSE;
//    }
//
...
//        gwkjs_throw(context, "Failed to get line property for function object");
//        return FALSE;
//    }
//
...
//    }
//
//    if (!get_array_from_js_value(context, &rval, sizeof(GwkjsCoverageFunction), clear_coverage_function, convert_and_insert_function_decl, &array)) {
//        gwkjs_log_exception(context);
//        return NULL;
//    }
//
...
//
//static void
//init_covered_branch(GwkjsCoverageBranch *branch,
//                    unsigned int       point,
//                    JSBool             was_hit,
//                    GArray            *exits)
//{
...
//{
//    GwkjsCoverageBranch *branch = (GwkjsCoverageBranch *) branch_location;
...
//        gwkjs_throw(context, "Branch exit array element is not an object");
//        return FALSE;
//    }
//
//    JSObjectRef object = JSVAL_TO_OBJECT(*element);
...
//        gwkjs_throw(context, "Failed to get line property from element");
//        return FALSE;
//    }
//
...
//        gwkjs_throw(context, "Failed to get hitCount property from element");
//        return FALSE;
//    }
//
//    hit_count = JSVAL_TO_INT(hit_count_value);
//
//    GwkjsCoverageBranchExit exit = {
//        (unsigned int) line,
//        (unsigned int) hit_count
//    };
//
...
//    if (!JSVAL_IS_OBJECT(*element) &&
//        !JSVAL_IS_VOID(*element)) {
//        gwkjs_throw(context, "Branch array element is not an object or undefined");
//        return FALSE;
//    }
//
//    if (JSVAL_IS_OBJECT(*element)) {
...
//            gwkjs_throw(context, "Failed to get point property from element");
//            return FALSE;
//        }
//
...
//            gwkjs_throw(context, "Failed to get exits property from element");
//            return FALSE;
//        }
//
//        if (!get_array_from_js_value(context,
//                                     &branch_exits_value,
//                                     sizeof(GwkjsCoverageBranchExit),
//                                     NULL,
...
//    }
//
//    if (!get_array_from_js_value(context, &rval, sizeof(GwkjsCoverageBranch), clear_coverage_branch, convert_and_insert_branch_info, &array)) {
//        gwkjs_log_exception(context);
//        return NULL;
//    }
//
...
//}
//
//typedef struct _GwkjsCoverageFileStatistics {
//    char       *filename;
//    GArray     *lines;
//    GArray     *functions;
//    GArray     *branches;
...
//
//static void
//gwkjs_coverage_statistics_file_statistics_clear(gpointer data)
//{
//    GwkjsCoverageFileStatistics *statistics = (GwkjsCoverageFileStatistics *) data;
...
//
//static void
//print_statistics_for_file(GwkjsCoverageFileStatistics *file_statistics,
...
//            goto error;
//
//        if (!gwkjs_string_to_utf8(context, element, &file))
//            goto error;
//
//        files[i] = file;
//    }
...
//
//gboolean
//gwkjs_get_path_mtime(const char *path, GTimeVal *mtime)
//{
...
//
//gchar *
//gwkjs_get_path_checksum(const char *path)
//{
...
//        gwkjs_log_exception(js_context);
//        return NULL;
//    }
//
...
//
//    if (!gwkjs_string_to_utf8(js_context,
//                            string_value_return.get(),
...
//
//JSString *
//gwkjs_deserialize_cache_to_object(GwkjsCoverage *coverage,
//                                GBytes      *cache_data)
//{
...
//    return gwkjs_deserialize_cache_to_object_for_compartment(context, global_object, cache_data);
//}
//
//GArray *
//gwkjs_fetch_statistics_from_js(GwkjsCoverage *coverage,
...
//                                                FALSE,
//                                                sizeof(GwkjsCoverageFileStatistics));
//    g_array_set_clear_func(file_statistics_array,
//                           gwkjs_coverage_statistics_file_statistics_clear);
//
//    JS::RootedObject rooted_coverage_statistics(JS_GetRuntime(js_context),
//                                                priv->coverage_statistics);
//
//    char                      **file_iter = coverage_files;
//    GwkjsCoverageFileStatistics *statistics_iter = (GwkjsCoverageFileStatistics *) file_statistics_array->data;
//    while (*file_iter) {
//        GwkjsCoverageFileStatistics statistics;
...
//
//gboolean
//gwkjs_write_cache_to_path(const char *path,
//                        GBytes     *cache)
//{
//    GFile *file = g_file_new_for_commandline_arg(path);
//    gsize cache_len = 0;
...
//
//void
//gwkjs_coverage_write_statistics(GwkjsCoverage *coverage,
//                              const char  *output_directory)
//{
//    GwkjsCoveragePrivate *priv = (GwkjsCoveragePrivate *) gwkjs_coverage_get_instance_private(coverage);
//    GError *error = NULL;
...
//    GArray *file_statistics_array = gwkjs_fetch_statistics_from_js(coverage,
//                                                                 executed_coverage_files);
//
//    for (size_t i = 0; i < file_statistics_array->len; ++i)
//    {
//        GwkjsCoverageFileStatistics *statistics = &(g_array_index(file_statistics_array, GwkjsCoverageFileStatistics, i));
//
...
//        GBytes *cache_data = gwkjs_serialize_statistics(coverage);
//        gwkjs_write_cache_to_path(priv->cache_path, cache_data);
...
//                  "coverage, set GWKJS_SHOW_COVERAGE_MESSAGES to see them.",
...
//
//static void
//gwkjs_coverage_init(GwkjsCoverage *self)
//{
//}
//
//static JSClass coverage_global_class = {
//    "GwkjsCoverageGlobal", JSCLASS_GLOBAL_FLAGS_WITH_SLOTS(GWKJS_GLOBAL_SLOT_LAST),
...
//        gwkjs_log_exception(js_context);
//        g_free(script);
//        g_set_error(error, GWKJS_ERROR, GWKJS_ERROR_FAILED, "Failed to evaluate %s", filename);
//        return FALSE;
//    }
//
//    g_free(script);
...
//    JSAutoRequest ar(context);
//
//    if (!g_getenv("GWKJS_SHOW_COVERAGE_MESSAGES")) {
//        _suppressed_coverage_messages_count++;
...
//    char *filename = NULL;
//
//    if (!gwkjs_parse_call_args(context, "getFileContents", "s", args,
//                             "filename", &filename))
//        return NULL;
//
//    return filename;
...
//
//    if (!filename) {
//        gwkjs_throw(context, "Failed to parse arguments for filename");
//        return NULL;
//    }
//
//    GFile *file = g_file_new_for_commandline_arg(filename);
...
//        goto out;
//
//    if (gwkjs_get_path_mtime(filename, &mtime)) {
...
//        return JS_FALSE;
//
//    char *checksum = gwkjs_get_path_checksum(filename);
//
//    if (!checksum) {
//        gwkjs_throw(context, "Failed to read %s and get its checksum", filename);
//        return JS_FALSE;
//    }
//
...
//                              NULL,
//                              &error)) {
//        gwkjs_throw(context, "Failed to load contents for filename %s: %s", filename, error->message);
//        goto out;
//    }
//
...
//    { "log", JSOP_WRAPPER(coverage_log), 1, GWKJS_MODULE_PROP_FLAGS },
//    { "getFileContents", JSOP_WRAPPER(coverage_get_file_contents), 1, GWKJS_MODULE_PROP_FLAGS },
//    { "getFileModificationTime", JSOP_WRAPPER(coverage_get_file_modification_time), 1, GWKJS_MODULE_PROP_FLAGS },
//    { "getFileChecksum", JSOP_WRAPPER(coverage_get_file_checksum), 1, GWKJS_MODULE_PROP_FLAGS },
//    { NULL }
//};
//
//static void
...
//{
//    GwkjsCoverage *coverage = (GwkjsCoverage *) data;
//    GwkjsCoveragePrivate *priv = (GwkjsCoveragePrivate *) gwkjs_coverage_get_instance_private(coverage);
//
...
// * compartment side */
//gboolean
//gwkjs_run_script_in_coverage_compartment(GwkjsCoverage *coverage,
//                                       const char  *script)
//{
//    GwkjsCoveragePrivate *priv = (GwkjsCoveragePrivate *) gwkjs_coverage_get_instance_private(coverage);
//    JSContextRef          js_context = (JSContextRef ) gwkjs_context_get_native_context(priv->context);
...
//
//gboolean
//gwkjs_inject_value_into_coverage_compartment(GwkjsCoverage     *coverage,
...
//
//static gboolean
//bootstrap_coverage(GwkjsCoverage *coverage)
//{
//    static const char  *coverage_script = "resource:///org/gnome/gwkjs/modules/coverage.js";
//    GwkjsCoveragePrivate *priv = (GwkjsCoveragePrivate *) gwkjs_coverage_get_instance_private(coverage);
...
//            gwkjs_throw(context, "Failed to wrap debugeee");
//            return FALSE;
//        }
//
...
//            gwkjs_throw(context, "Failed to set debuggee property");
//            return FALSE;
//        }
//
//        if (!JS_InitStandardClasses(context, debugger_compartment)) {
//            gwkjs_throw(context, "Failed to init standard classes");
//            return FALSE;
//        }
//
//        if (!JS_InitReflect(context, debugger_compartment)) {
//            gwkjs_throw(context, "Failed to init Reflect");
//            return FALSE;
//        }
//
//        if (!JS_DefineDebuggerObject(context, debugger_compartment)) {
//            gwkjs_throw(context, "Failed to init Debugger");
//            return FALSE;
//        }
//
//        JS::RootedObject wrapped_importer(JS_GetRuntime(context),
//                                          gwkjs_wrap_root_importer_in_compartment(context,
//                                                                                debugger_compartment));;
//
//        if (!wrapped_importer) {
//            gwkjs_throw(context, "Failed to wrap root importer in debugger compartment");
//            return FALSE;
//        }
//
...
//         */
//        if (!gwkjs_define_root_importer_object(context, debugger_compartment, wrapped_importer)) {
//            gwkjs_throw(context, "Failed to set 'imports' on debugger compartment");
//            return FALSE;
//        }
//
...
//
//        if (!gwkjs_context_eval_file_in_compartment(priv->context,
//                                                  coverage_script,
//                                                  debugger_compartment,
//                                                  &error))
...
//            gwkjs_throw(context, "Failed to get CoverageStatistics prototype");
//            return FALSE;
//        }
//
...
//
//        if (cache_bytes) {
//            JSString *cache_object = gwkjs_deserialize_cache_to_object_for_compartment(context,
//                                                                                     debugger_compartment,
//                                                                                     cache_bytes);
...
//            gwkjs_throw(context, "Failed to create coverage_statitiscs object");
//            return FALSE;
//        }
//
...
//
//static void
//gwkjs_coverage_constructed(GObject *object)
//{
//    G_OBJECT_CLASS(gwkjs_coverage_parent_class)->constructed(object);
//
...
//
//static void
//gwkjs_coverage_set_property(GObject      *object,
...
//        break;
//    case PROP_CONTEXT:
//        priv->context = GWKJS_CONTEXT(g_value_dup_object(value));
//        break;
//    case PROP_CACHE:
...
//
//static void
//gwkjs_clear_js_side_statistics_from_coverage_object(GwkjsCoverage *coverage)
//{
//    GwkjsCoveragePrivate *priv = (GwkjsCoveragePrivate *) gwkjs_coverage_get_instance_private(coverage);
//
...
//
//static void
//gwkjs_coverage_dispose(GObject *object)
//{
//    GwkjsCoverage *coverage = GWKJS_COVERAGE(object);
//    GwkjsCoveragePrivate *priv = (GwkjsCoveragePrivate *) gwkjs_coverage_get_instance_private(coverage);
//
...
//    gwkjs_clear_js_side_statistics_from_coverage_object(coverage);
//    g_clear_object(&priv->context);
//
//    G_OBJECT_CLASS(gwkjs_coverage_parent_class)->dispose(object);
//}
//
//static void
//gwkjs_coverage_finalize (GObject *object)
//{
//    GwkjsCoverage *coverage = GWKJS_COVERAGE(object);
//    GwkjsCoveragePrivate *priv = (GwkjsCoveragePrivate *) gwkjs_coverage_get_instance_private(coverage);
//
...
//
//    G_OBJECT_CLASS(gwkjs_coverage_parent_class)->finalize(object);
//}
//
//static void
//gwkjs_coverage_class_init (GwkjsCoverageClass *klass)
//{
//    GObjectClass *object_class = (GObjectClass *) klass;
//
//    object_class->constructed = gwkjs_coverage_constructed;
//    object_class->dispose = gwkjs_coverage_dispose;
//    object_class->finalize = gwkjs_coverage_finalize;
//    object_class->set_property = gwkjs_coverage_set_property;
//
...
// * coverage_data for
// *
// * Returns: A #GwkjsCoverage object
// */
//GwkjsCoverage *
//gwkjs_coverage_new (const char **prefixes,
//                  GwkjsContext  *context)
//{
//    GwkjsCoverage *coverage =
//        GWKJS_COVERAGE(g_object_new(GWKJS_TYPE_COVERAGE,
//                                  "prefixes", prefixes,
//                                  "context", context,
//                                  NULL));
//
...
//
///**
// * gwkjs_coverage_new_from_cache:
// * Creates a new GwkjsCoverage object, but uses @cache_path to pre-fill the AST information for
// * the specified scripts in coverage_paths, so long as the data in the cache has the same
// * mtime as those scripts.
// *
// * @coverage_prefixes: (transfer none): A null-terminated strv of prefixes of files to perform coverage on
// * @context: (transfer full): A #GwkjsContext object.
// * @cache_path: A path to a file containing a serialized cache.
// *
// * Returns: A #GwkjsCoverage object
// */
//GwkjsCoverage *
//gwkjs_coverage_new_from_cache(const char **coverage_prefixes,
//                            GwkjsContext *context,
