...
// GWKJS: introduce implicit variable to avoid exceptions
var top = null;
...
// GWKJS: comment out as isLoaded() isn't terribly useful for us
//jsUnitSetOnLoad(window, newOnLoadEvent);

// GWKJS: entry point to run all functions named as test*, surrounded by
// calls to setUp() and tearDown()
function gwkjstestRun(window_, setUp, tearDown) {
  var propName;
  var rv = 0;
  var failures = [];
  ...
  // if gwkjstestRun() is the last call in a file, this becomes the
