 ...
 */
var TestIface = '<node> \
<interface name="org.gnome.gwkjs.Test"> \
...
Test.prototype = {
    _init: function(){
        ...
        this._impl.export(Gio.DBus.session, '/org/gnome/gwkjs/Test');
    },
...
function testExportStuff() {
    ...
    own_name_id = Gio.DBus.session.own_name('org.gnome.gwkjs.Test',
...
function testThrowException() {
    ...
    GLib.test_expect_message('Gwkjs', GLib.LogLevelFlags.LEVEL_WARNING,
